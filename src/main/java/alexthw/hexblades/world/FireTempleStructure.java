...
public class FireTempleStructure extends Structure<NoFeatureConfig> {
    public FireTempleStructure(Codec<NoFeatureConfig> pCodec) {
        super(pCodec);
    }
    ...
    protected boolean isFeatureChunk(ChunkGenerator chunkGenerator, BiomeProvider biomeSource, long seed, SharedSeedRandom chunkRandom, int chunkX, int chunkZ, Biome biome, ChunkPos chunkPos, NoFeatureConfig featureConfig) {
        ...
        // Grabs column of blocks at given position. Then combine the column of blocks
        // with land height and you get the top block itself which you can test.
    ...
    private static class Start extends StructureStart<NoFeatureConfig> {
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
             ...
             */
            BlockPos centerPos = new BlockPos(x, 32, z);
            ...
            BlockPos placementPos = WorldGenUtil.getLowestLand(chunkGenerator, this.getBoundingBox(), true);
            ...
            JigsawManager.addPieces(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            .get(new ResourceLocation(Hexblades.MODID, "fire_temple/ft_starts")),
            ...
            Hexblades.LOGGER.log(Level.DEBUG, "Rundown House at " +
