...
public class CodexHexChapters {
    ...
    public static void init() {
        ...
        BLACK_PLANKS = new Chapter("hexblades.codex.chapter.planks", new TitlePage("hexblades.codex.page.dark_planks"),
        ...
        URN_OF_WATERS = new Chapter("hexblades.codex.chapter.urn", new TitlePage("hexblades.codex.page.everfull_urn"),
        ...
        MISC = new Chapter("hexblades.codex.chapter.misc",
        ...
        TEMPLES = new Chapter("hexblades.codex.chapter.structures",
                new TextPage("hexblades.codex.page.elemental"),
                new RitualPage(HexRituals.SUMMON_FIRE, new ItemStack(HexItem.FIRE_CORE.get()),
                        new RitualPage.RitualIngredient(new ItemStack(HexItem.SOUL_BAIT.get()), false)
                )
        );

        if (CompatUtil.isMalumLoaded()) {
            COMPAT = new Chapter("hexblades.codex.chapter.compats", new TitlePage("hexblades.codex.page.compats"), new TitlePage("hexblades.codex.page.compats.malum"), new ListPage("hexblades.codex.page.altar_ether", new ListPage.ListEntry("brazier", new ItemStack(MalumItems.BLUE_ETHER_BRAZIER.get()))));
        } else {
            COMPAT = new Chapter("hexblades.codex.chapter.compats", new TitlePage("hexblades.codex.page.compats"));
        }
        ...
        HEX_ALLOY = new Chapter("hexblades.codex.chapter.hex_metal", new TitlePage("hexblades.codex.page.hex_metal.0"),
                //ingot
                new CruciblePage(new ItemStack(HexItem.HEXIUM_INGOT.get(), 2),
        ...
        SANGUINE_UPGRADE = new Chapter("hexblades.codex.chapter.sanguine_upgrade",
                new TitlePage("hexblades.codex.page.sanguine_wither")
        );
        ...
        HEXBLADES_INDEX = new Chapter("hexblades.codex.chapter.hex_index",
                ...
                new IndexPage(
                        ...
                        new IndexPage.FactLockedEntry(HEX_INFUSION, new ItemStack(HexItem.FIRE_CORE.get()), HexFacts.STAR_INFUSION),
                        new IndexPage.FactLockedEntry(HEX_EVOLUTION, new ItemStack(HexItem.PATRON_SOUL2.get()), HexFacts.EVOLVE_RITUAL)
                )
        );
        HEXBLADES_WINDEX = new Chapter("hexblades.codex.chapter.weapon_index",
                ...
                new IndexPage(
                        new IndexPage.FactLockedEntry(SANGUINE_UPGRADE, new ItemStack(HexItem.BLOOD_SWORD.get()), HexFacts.AWAKENING_RITUAL)
                )
        );

        if (CCategories != null) {
            CCategories.add(HEXBLADES = new Category("hexblades", new ItemStack(HexItem.PATRON_SOUL.get()), ColorUtil.packColor(220, 0, 30, 66), HEXBLADES_INDEX));
