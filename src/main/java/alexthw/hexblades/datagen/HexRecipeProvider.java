...
public class HexRecipeProvider extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(HexBlock.DARK_POLISH_PLANKS.getBlock().asItem()).define('#', Items.BLACK_DYE).define('X', Registry.POLISHED_PLANKS.getBlock().asItem()).pattern("XXX").pattern("X#X").pattern("XXX").unlockedBy("has_polished_wood", has(Registry.POLISHED_PLANKS.getBlock().asItem())).save(consumer);
        ShapedRecipeBuilder.shaped(HexBlock.DARK_POLISH_PLANKS.getSlab().asItem()).define('X', HexBlock.DARK_POLISH_PLANKS.getBlock().asItem()).pattern("   ").pattern("   ").pattern("XXX").unlockedBy("has_dark_polished_wood", has(HexBlock.DARK_POLISH_PLANKS.getBlock().asItem())).save(consumer);
        ShapedRecipeBuilder.shaped(HexBlock.DARK_POLISH_PLANKS.getStairs().asItem()).define('X', HexBlock.DARK_POLISH_PLANKS.getBlock().asItem()).pattern("X  ").pattern("XX ").pattern("XXX").unlockedBy("has_dark_polished_wood", has(HexBlock.DARK_POLISH_PLANKS.getBlock().asItem())).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(HexBlock.DARK_POLISH_PLANKS.getFence().asItem()).define('#', Items.STICK).define('X', HexBlock.DARK_POLISH_PLANKS.getBlock().asItem()).pattern("   ").pattern("X#X").pattern("X#X").unlockedBy("has_dark_polished_wood", has(HexBlock.DARK_POLISH_PLANKS.getBlock().asItem())).save(consumer);
