...
public class FireElementalModel extends EntityModel<BaseElementalEntity> {
    ...
    public FireElementalModel() {
        ...
        head.setTextureOffset(0, 16).addBox(-3.0F, -0.5F, -3.0F, 6.0F, 1.0F, 6.0F, 0.0F, false);

        left_arm = new ModelRenderer(this);
        left_arm.setRotationPoint(-4.0F, -11.5F, 0.0F);
        master.addChild(left_arm);
        left_arm.setTextureOffset(0, 23).addBox(-2.0F, -1.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);
